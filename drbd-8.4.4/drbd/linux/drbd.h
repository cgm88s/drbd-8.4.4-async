...
#define DRBD_PROT_S   19     //A:65,S:83 add for snapshot,chengm@vanstor.com
...
#define MDF_SNAPSHOT_SYNC_S (1<<10)   //add by chengm 0x400
#define MDF_SNAPSHOT_SYNC_T (1<<11)     //0x800
